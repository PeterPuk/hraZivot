...
void zistiStlacenuKlavesu();

static void* ovladanie(void* args);
static void* simuluj(void* args);
...
int main(int argc, char *argv[]) {
    ...
    DATA dataV = {&mutex,0,pocetRiadkov,pocetStlpcov,poradoveCisloHry,0,svet};
